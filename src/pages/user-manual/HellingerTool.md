...
The Hellinger tool is one of the Workflows visible at the left hand side of the main window, and can be started by selecting the Hellinger icon: ![](icons/hellinger_35.png) or using the shortcut **7**. On starting the tool, the Hellinger dialog window will open.
...
Selecting output filenames and locations
----------------------------------------
...
Providing fit settings, and performing the fit
----------------------------------------------
...
Estimating the fit uncertainty
------------------------------
